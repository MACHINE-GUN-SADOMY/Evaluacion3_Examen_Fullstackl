...
public class ClienteService {
    ...
    public ClienteResponse createCliente(ClienteRequest clienteRequest) {
        // Validación: asegurar que el email del cliente sea único
        ...
        // Validación: asegurar que el teléfono del cliente sea único si no es nulo
        ...
        // Crear la entidad ClienteJpa y asignar los valores del request
